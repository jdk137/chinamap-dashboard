var Column = function (container, chartWidth, chartHeight, config) {
  ...
  var barWidthRatio = config && config.barWidthRatio || 0.9;
  ...
  var label = d3.scale.ordinal()
      .rangeRoundBands([0, w], 1 - barWidthRatio)
  ...
  if (typeof bgLineValues !== 'undefined') {
    canvas.selectAll(".bgLine")
      ...
      .enter().append("path")
        .attr("class", "bgLine")
        .attr("d", function (d) { return "M0," + value(d) + "H" + w; })
        .attr("fill", "none")
  ...
  canvas.selectAll(".bar")
    ...
    .enter().append("rect")
      .attr("class", "bar")
      .attr("x", function(d) { return label(d.label); })
      .attr("width", label.rangeBand())
      .attr("y", function(d) { return h; })
      .attr("height", 0)
      .attr("fill", color)
    .transition()
      .duration(500)
      .attr("y", function(d) { return value(d.value); })
      .attr("height", function(d) { return h - value(d.value); });
